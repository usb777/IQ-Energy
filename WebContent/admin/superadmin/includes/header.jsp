...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link  href="<%=request.getContextPath()%>/admin/superadmin/css/bootstrap.css" rel="stylesheet">
    <!-- Add custom CSS here -->
    ...
    src='https://cdn.tiny.cloud/1/epldjxj1h4wfvqozdf6bo18umiw4tc4os15u6bbo5jyub3u2/tinymce/5/tinymce.min.js'
